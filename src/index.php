...
<body>
    <nav class=" p-4 flex justify-between items-center bg-slate-200 static">
        ...
        <div class="actionBtn flex justify-between w-[9%]">
            <a href="admin/auth/login.php" class="admininfo bg-violet-400 px-3 py-1 rounded-lg text-white hover:bg-violet-500">
                Login
            </a>
            <a href="./view_cart.php" class="relative inline-flex items-center text-sm font-medium text-center">
